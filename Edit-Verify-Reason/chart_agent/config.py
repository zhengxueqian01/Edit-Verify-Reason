...
MODEL_CONFIGS: dict[str, ModelConfig] = {
    ...
    "qwen": ModelConfig(
        ...
        rpm_limit=_get_env_int("QWEN_RPM_LIMIT", 1200),
        tpm_limit=_get_env_int("QWEN_TPM_LIMIT", 15000),
        rate_limit_retries=_get_env_int("QWEN_RATE_LIMIT_RETRIES", 3),
    ),
    "doubao": ModelConfig(
        name="doubao",
    ...
    "qwen-aihubmix": ModelConfig(
        name="qwen-aihubmix",
        model=_get_env("QWEN_AIHUBMIX_MODEL", "qwen3-vl-235b-a22b-instruct")
        or "qwen3-vl-235b-a22b-instruct",
        api_key=AIHUBMIX_API_KEY,
        base_url=_get_env("QWEN_AIHUBMIX_BASE_URL", "https://aihubmix.com/v1"),
        temperature=_get_env_float("QWEN_AIHUBMIX_TEMPERATURE", 0.0),
    ),
}
