...
from main import (
    _validate_area_delete_step,
    _validate_area_change_step,
...
class RenderValidatorTests(unittest.TestCase):
    ...
    def test_validate_area_delete_step_rejects_missing_non_target_legend_item(self) -> None:
        input_svg = """
        <svg xmlns="http://www.w3.org/2000/svg">
          <g id="axes_1"></g>
          <g id="legend_1">
            ...
            <g id="text_1"><!-- Alpha --><g transform="translate(30 20) scale(0.1 -0.1)"></g></g>
            <g id="patch_2"><path d="M 0 10 L 5 10 L 5 15 L 0 15 z" style="fill: #222222" /></g>
            <g id="text_2"><!-- Beta --><g transform="translate(30 34) scale(0.1 -0.1)"></g></g>
            <g id="patch_3"><path d="M 0 20 L 5 20 L 5 25 L 0 25 z" style="fill: #333333" /></g>
        ...
        """
        with tempfile.TemporaryDirectory() as tmpdir:
            input_path = self._write_svg(tmpdir, "input.svg", input_svg)
            output_path = self._write_svg(tmpdir, "output.svg", bad_output_svg)

            result = _validate_area_delete_step(
                {
                    "input_svg_path": str(input_path),
                    "output_svg_path": str(output_path),
                    "question": 'Delete category "Beta"',
                    "operation_target": {"category_name": "Beta"},
                    "data_change": {"category_name": "Beta"},
                }
            )

        self.assertFalse(result["ok"])
        self.assertIn("non-target legend item missing", result["issues"][0])

    def test_validate_area_change_step_rejects_unexpected_added_legend_item(self) -> None:
        input_svg = """
        <svg xmlns="http://www.w3.org/2000/svg">
          <g id="axes_1">
            <g id="FillBetweenPolyCollection_1"><path d="M 0 90 L 10 80 L 20 70 L 20 100 L 10 100 L 0 100 z" style="fill: #111111" /></g>
            <g id="FillBetweenPolyCollection_2"><path d="M 0 70 L 10 60 L 20 50 L 20 70 L 10 80 L 0 90 z" style="fill: #222222" /></g>
          </g>
          <g id="legend_1">
            <g id="patch_1"><path d="M 0 0 L 5 0 L 5 5 L 0 5 z" style="fill: #111111" /></g>
            <g id="text_1"><!-- Alpha --><g transform="translate(30 20) scale(0.1 -0.1)"></g></g>
        ...
        <svg xmlns="http://www.w3.org/2000/svg">
          <g id="axes_1">
            <g id="FillBetweenPolyCollection_1"><path d="M 0 90 L 10 80 L 20 70 L 20 100 L 10 100 L 0 100 z" style="fill: #111111" /></g>
            <g id="FillBetweenPolyCollection_2"><path d="M 0 70 L 10 60 L 20 50 L 20 70 L 10 80 L 0 90 z" style="fill: #222222" /></g>
            <g id="FillBetweenPolyCollection_3"><path d="M 0 50 L 10 40 L 20 30 L 20 50 L 10 60 L 0 70 z" style="fill: #333333" /></g>
          </g>
          <g id="legend_1">
            <g id="patch_1"><path d="M 0 0 L 5 0 L 5 5 L 0 5 z" style="fill: #111111" /></g>
            <g id="text_1"><!-- Alpha --><g transform="translate(30 20) scale(0.1 -0.1)"></g></g>
            ...
            <g id="text_2"><!-- Beta --><g transform="translate(30 34) scale(0.1 -0.1)"></g></g>
            <g id="patch_3"><path d="M 0 20 L 5 20 L 5 25 L 0 25 z" style="fill: #333333" /></g>
            <g id="text_3"><!-- change --><g transform="translate(30 48) scale(0.1 -0.1)"></g></g>
          </g>
        </svg>
        """
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            result = _validate_area_change_step(
                {
                    "input_svg_path": str(input_path),
                    "output_svg_path": str(output_path),
                    "validation_context": {
                        "x_ticks": [(0.0, 2018.0), (10.0, 2019.0), (20.0, 2020.0)],
                        "y_ticks": [(100.0, 0.0), (0.0, 100.0)],
                    },
                    "operation_target": {"category_name": "Alpha"},
                    "data_change": {"changes": [{"category_name": "Alpha", "years": [2019], "values": [20]}]},
                }
            )

        self.assertFalse(result["ok"])
        self.assertIn("unexpected area legend item added", result["issues"][0])
