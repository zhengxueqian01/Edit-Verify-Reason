...
def build_visual_tool_planner_prompt(
    *,
    ...
    return (
        ...
        "  * area: use highlight_top_boundary when the task benefits from tracing the upper envelope; use add_point/draw_line/highlight_rect as light local guides when needed.\n"
